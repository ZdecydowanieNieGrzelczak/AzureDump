...
class ConvEnv:
    ...
    def step(self, action):
        ...
        additional_reward, should_oracle = self.action_special()
        reward += additional_reward
        if self.normalize_reward:
            reward /= self.reward_normalizer
        state = (self.get_state_object(), reward, self.is_done, should_oracle)
        return state
    ...
    def action_special(self):
        ...
        if tile_code == 0:
            ...
            if self.cargo[quest] == 0:
                ...
                # return 2.5
                # return self.rewards[quest] * self.prepaid * self.quest_multiplier, False
                return self.quest_reward * self.prepaid * self.quest_multiplier, False
            ...
            if self.cargo[quest] == 1:
                ...
                return self.quest_reward * self.quest_multiplier * (1 - self.prepaid), False
                # return 10
        return 0, True
